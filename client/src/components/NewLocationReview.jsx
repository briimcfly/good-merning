...
import {
	Input,	Button,	Box,	ButtonGroup,	FormControl,	FormLabel,	Modal,	ModalOverlay,	ModalContent,	ModalHeader,	ModalBody,	ModalCloseButton,	Stack,	Alert,	AlertIcon,	AlertTitle,	AlertDescription,	Accordion,	AccordionItem,	AccordionButton,	AccordionPanel,	AccordionIcon,	Radio,	RadioGroup, Text, IconButton, ModalFooter,
							...
							<Accordion allowToggle>
								...
								<AccordionItem>
									...
									<AccordionPanel pb={4}>
										...
										<Legend category="areaScore" subcategory="noise" score="" />
										<Text color="green" as="em" fontSize="md">
											Noise Level
										</Text>
										<RadioGroup colorScheme="green" onChange={handleCheck}>
